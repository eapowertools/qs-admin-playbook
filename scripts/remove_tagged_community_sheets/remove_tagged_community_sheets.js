...
var dateString = dateObject.toISOString().replace(/:/g, '-');
var outputFilePath = "output-" + dateString + ".csv";
var logFilePath = "log-" + dateString + ".txt";
...
try {
    ...
    requestParams['path'] = "/qrs/app/object/full?filter=objectType+eq+'sheet'+and+published+eq+true+and+approved+eq+false+and+tags.name+eq+'" + TAG_TO_SEARCH_FOR + "'&xrfkey=0123456789ABCDEF";
